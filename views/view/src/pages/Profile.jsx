...
const Profile = () => {
  const [userId = 1, setUserId] = useState();
  ...
  const handleSaveDataChanges = () => {
    axios.put(`http://localhost:5002/user/${userId}`, {
      ...
      .then(response => {
        ...
        // Update the component's state to reflect the saved changes
                ...
                <div className="flex flex-col gap-2 w-full border-gray-400">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      value={newUserData.username} // Update value to newUserData.username
                      onChange={e => setNewUserData({ ...newUserData, username: e.target.value })} // Set newUserData.username on change
                    />
